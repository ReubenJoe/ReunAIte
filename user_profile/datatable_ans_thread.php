...
$sql="SELECT * FROM `find` WHERE `img_name`='$img_id'";
$result=mysqli_query($conn,$sql);
// echo '<pre>' . print_r($sql, TRUE) . '</pre>';
while($row = mysqli_fetch_array($result))
{
    $st_guardian = $row['guardian_name'];
    $st_name = $row['patient_name'];
    $st_email = $row['email'];
    $st_phone = $row['phone'];
    $st_latitude = $row['Latitude'];
    $st_longitude = $row['Longitude'];
    $st_age = $row['age_group'];
    $st_gender = $row['gender'];
    $st_birthmark = $row['birthmark'];
...
?>
            ...
            <div class="card card-info mx-4">
                <div class="card-header"  style="background:#ff4583">
                    <h3 class="card-title"><?php echo $st_guardian?>'s Details</h3>
                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" style="background:white;" class="form-control" value="<?php echo $st_guardian?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <i class="input-group-text fas fa-envelope"></i>
                        </div>
                        <input type="email" style="background:white" class="form-control" value="<?php echo $st_email?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" style="background:white" class="form-control" value="<?php echo $st_phone?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <!-- <i class="input-group-text fas fa-phone" style="color:black"></i> -->
                        <span class="input-group-text"><i class="far fa-calendar-alt text-dark"></i></span>
                        
                        </div>
                        <input type="text" style="background:white" class="form-control" value="<?php echo $st_age?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <!-- <i class="input-group-text fas fa-phone" style="color:black"></i> -->
                        ...
                        <input type="text" style="background:white" class="form-control" value="<?php echo $st_gender?>" readonly>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <!-- <i class="input-group-text fas fa-phone" style="color:black"></i> -->
                        ...
                        <input type="text" style="background:white" class="form-control" value="<?php echo $st_birthmark?>" readonly>
                    </div>
                </div>
                <!-- /.card-body -->
            </div>
            ...
            <div class="card bg-white mx-4">
                <div class="card-header border-0">
                    <h3 class="card-title">
                        ...
                        <?php echo $st_guardian?>'s location
                    </h3>
                    <!-- card tools -->
                    <div class="card-tools">
                ...
                <div class="card-body">
                    <iframe width="100%" height="500"
                        src="https://maps.google.com/maps?q=<?php echo $st_latitude; ?>,<?php echo $st_longitude; ?>&output=embed"></iframe>
                </div>
            </div>
            <!-- /.card -->
